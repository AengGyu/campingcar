...
public class UserPanel extends JPanel {
    ...
    public UserPanel(MainFrame frame, Connection conn) {
        ...
        JButton availableDateBtn = new JButton("대여 가능 일자 조회");
        JButton rent = new JButton("대여 등록");
        JButton rentInfo = new JButton("대여 정보 확인");
        JButton deleteRentInfo = new JButton("대여 정보 삭제");
        ...
        rentInfo.addActionListener(e-> setContent(null));
